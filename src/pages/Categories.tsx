          ...
          {loading ? (
            <div className="flex items-center justify-center h-64">
              <div className="relative">
                <div className="w-16 h-16 rounded-full border-4 border-primary/20 border-t-primary/60 animate-spin" />
                <Loader2 className="absolute inset-0 m-auto w-8 h-8 text-primary" />
              </div>
            </div>
          ) : (
