...
const Wishlist = () => {
  ...
  const handleAddToCart = (product: { id: string; name: string; price: number; slug: string; images: string[] }) => {
    addToCart({
              ...
              >
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full py-3 bg-primary text-white rounded-xl hover:bg-primary/90 transition-all hover:scale-105 font-medium flex items-center justify-center gap-2 shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-destructive/10 text-destructive rounded-xl hover:bg-destructive/20 transition-all hover:scale-105 font-medium flex items-center justify-center gap-2"
                  >
