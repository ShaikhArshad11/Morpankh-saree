...
const OrdersPage = () => {
  ...
  const getProductImage = (productId: string) => {
    const productImages: { [key: string]: string } = {
      '1': 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=100&h=100&fit=crop',
      '2': 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=100&h=100&fit=crop',
      '3': 'https://images.unsplash.com/photo-1594463750939-ebb28c3f7f75?w=100&h=100&fit=crop',
      '4': 'https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=100&h=100&fit=crop',
      '5': 'https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?w=100&h=100&fit=crop',
      '6': 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d44?w=100&h=100&fit=crop',
      '7': 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=100&h=100&fit=crop',
      '8': 'https://images.unsplash.com/photo-1605518216938-7c31b7b14ad0?w=100&h=100&fit=crop',
      '9': 'https://images.unsplash.com/photo-1594463750939-ebb28c3f7f75?w=100&h=100&fit=crop',
      '10': 'https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=100&h=100&fit=crop'
    };
    return productImages[productId] || 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=100&h=100&fit=crop';
  };
